  ...
  function CustomDialog(props) {
    ...
    _this.setupDatepicker = function () {
      ...
      if (self.state.focusOn === 'end' && self.state.endText) {
        var twoMonthAgo = (0, _momentTimezone2.default)(self.state.endText).subtract(2, 'months').format('YYYY/MM/DD');
      ...
      $datepicker.datepicker({
        ...
        beforeShowDay: function beforeShowDay(date) {
          var cssClasses = [];
          var selectedDate = _datepicker2.default.formatDate('yy/mm/dd', date);
