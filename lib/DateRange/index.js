...
var _Helpers3 = require('../utils/Helpers');
...
var DateRange = function (_Component) {
  ...
  function DateRange() {
    ...
    var _this = _possibleConstructorReturn(this, (DateRange.__proto__ || Object.getPrototypeOf(DateRange)).call(this));
  ...
  _createClass(DateRange, [{
    ...
    value: function renderRangeTypeOptions() {
      ...
      var typeOptions = this.props.rangeTypes.map(function (rangeType) {
        var humanRangeType = _Helpers2.default.humanizeDateRange({ rangeType: rangeType }, _this2.props.tzName, _this2.props.dateFormat, _this2.props.optionsText);
      ...
      if (this.props.theme === 'select' && this.props.rangeType === 'custom' && this.props.start_at && this.props.end_at) {
        var selectTitle = _Helpers2.default.humanizeDateRange({ rangeType: this.props.rangeType, start_at: this.props.start_at, end_at: this.props.end_at }, this.props.tzName, this.props.dateFormat, this.props.optionsText);
        return [_react2.default.createElement(
          'option',
    ...
    value: function renderAsDropdown() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Dropdown2.default.Toggle, {
          ...
          title: _Helpers2.default.humanizeDateRange(value, this.props.tzName, this.props.dateFormat, this.props.optionsText)
        }),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'span',
        (0, _Helpers3.t)(this.props.tagName),
...
DateRange.propTypes = {
  ...
  customTitle: _react.PropTypes.string.isRequired,
  customApplyText: _react.PropTypes.string.isRequired,
  optionsText: _react.PropTypes.object.isRequired,
