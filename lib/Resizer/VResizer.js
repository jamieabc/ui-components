...
var VResizer = function (_Component) {
  ...
  function VResizer(props) {
    ...
    var _this = _possibleConstructorReturn(this, (VResizer.__proto__ || Object.getPrototypeOf(VResizer)).call(this, props));
    ...
    _this.handleClick = function (e) {
      ...
      if (_this.props.hiddenSide === 'right') {
        if (_this.props.rightOpened) {
          leftWidth = _this.props.leftWidth + _this.props.rightWidth;
          rightWidth = 0;
        } else {
  ...
  _createClass(VResizer, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'ui-layout-resizer ui-layout-resizer-vertical', ref: 'resizer', onMouseDown: this.handleMouseDown, style: { 'float': 'left' } },
