...
var ActionDialog = function (_Component) {
  ...
  function ActionDialog(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ActionDialog.__proto__ || Object.getPrototypeOf(ActionDialog)).call(this, props));
    ...
    _this.getData = function (offset, limit, orderStr) {
      ...
      return (0, _sortBy2.default)(_this.props.dataSource, [order.name, order.dir]).slice(offset, offset + limit);
    };
    return _this;
  }
  ...
  _createClass(ActionDialog, [{
    ...
    value: function render() {
      ...
      var scrollbarSize = function () {
        if (!_this2.props.maxRowCount) {
          return 0;
        }

        return _this2.props.maxRowCount < pageDataSource.length ? 20 : 0;
      }();
      var rowCount = scrollbarSize > 0 ? this.props.maxRowCount : pageDataSource.length;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { bsClass: this.props.bodyClassName, style: (0, _assign2.default)({}, this.props.bodyStyle, { maxHeight: maxHeight }) },
          this.props.warning,
          ...
          _react2.default.createElement(
            ...
            this.props.pager && _react2.default.createElement(
              'div',
...
ActionDialog.propTypes = {
  ...
  childPosition: _react.PropTypes.string,
  pager: _react.PropTypes.bool,
