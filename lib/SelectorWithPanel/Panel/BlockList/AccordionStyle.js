...
var Accordion = function (_Component2) {
  ...
  _createClass(Accordion, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var newItems = (0, _differenceBy2.default)(nextProps.dataSource, this.props.dataSource, this.context.idKey);
      var newActiveKey = newItems[0] ? newItems[0][this.context.idKey] : null;
